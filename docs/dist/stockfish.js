...
export class StockfishEngine {
     ...
     */
    async analyzePosition(fen, depth = 15, timeMs = 1000) {
    ...
    parseAnalysis(output) {
        ...
        const bestMoves = Array.from(moveMap.values()).sort((a, b) => {
            ...
            if (a.mate !== undefined && b.mate === undefined)
                return -1;
            if (b.mate !== undefined && a.mate === undefined)
                return 1;
            if (a.mate !== undefined && b.mate !== undefined) {
     ...
     */
    boardToFEN(board, currentTurn, moveHistory) {
        let fen = '';
        // Board position
